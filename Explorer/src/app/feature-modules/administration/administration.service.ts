...
export class AdministrationService {
  ...
  getByProfileUserId(id: number): Observable<Profile> {
    return this.http.get<Profile>('http://localhost:44333/api/administration/profile/by-id/' + id);
  }
  
  getById(message: Message): Observable<Profile> {
    return this.http.get<Profile>('http://localhost:44333/api/administration/profile/by-id/' + message.senderId);
  }

  getById2(message: Message): Observable<Profile> {
    return this.http.get<Profile>('http://localhost:44333/api/administration/profile2/by-id/' + message.senderId);
  }

  getByUserId(): Observable<Profile> {
    return this.http.get<Profile>('http://localhost:44333/api/administration/profile/by-user');
  }

  getProfileByUserId(id: number): Observable<Profile> {
    return this.http.get<Profile>('http://localhost:44333/api/administration/profile/get-profile-by-user'+ id);
  }

  getByUserId2(): Observable<Profile> {
    return this.http.get<Profile>('http://localhost:44333/api/administration/profile2/by-user');
  }
  
  updateProfile(profile: Profile): Observable<Profile> {
    return this.http.patch<Profile>('http://localhost:44333/api/administration/profile/' + profile.id + '/' + profile.userId, profile);
  }

  updateProfile2(profile: Profile): Observable<Profile> {
    return this.http.patch<Profile>('http://localhost:44333/api/administration/profile2/' + profile.id + '/' + profile.userId, profile)
      .pipe(
  ...
  upload(file: File): Observable<HttpEvent<any>> {
    ...
    const req = new HttpRequest('POST', `http://localhost:44333/api/administration/profile/UploadFile`, formData, {
      reportProgress: true,
      responseType: 'json'
    });
  ...
  upload2(file: File): Observable<HttpEvent<any>> {
    ...
    const req = new HttpRequest('POST', `http://localhost:44333/api/administration/profile2/UploadFile`, formData, {
      reportProgress: true,
      responseType: 'json'
    });
  ...
  getPublicRequests(): Observable<PagedResults<PublicRequest>> {
    return this.http.get<PagedResults<PublicRequest>>('http://localhost:44333/api/administrator/publicRequest');
  }

  updatePublicRequest(pr: PublicRequest): Observable<PublicRequest> {
    return this.http.put<PublicRequest>('http://localhost:44333/api/administrator/publicRequest/update/' + pr.id, pr);
  }
  ...
  addFollowNeo4j(follow: Follow): Observable<Follow> {
    return this.http.put<Follow>(environment.apiHost + 'administration/profile/AddFollow/neo4j', follow);
  }

  getFollowersByFollowingNeo4j(userId: number): Observable<Profile[]> {
    return this.http.get<Profile[]>(environment.apiHost + 'administration/profile/GetFollowing/GetFollowersByFollowing/' + userId);
  }
  ...
  updateMessage(message: Message): Observable<Message> {
    return this.http.put<Message>('http://localhost:44333/api/administration/message/' + message.id + '/' + message.senderId + '/' + message.receiverId, message);
  }

  updateMessage2(message: Message): Observable<Message> {
    return this.http.put<Message>('http://localhost:44333/api/administration/message2/' + message.id + '/' + message.senderId + '/' + message.receiverId, message);
  }

  //WALLET
  getWalletByUserId(): Observable<Wallet> {
    return this.http.get<Wallet>('http://localhost:44333/api/administrator/wallet/byUser');
  }

  getAllWallets(): Observable<PagedResults<Wallet>> {
    return this.http.get<PagedResults<Wallet>>('http://localhost:44333/api/administrator/wallet');
  }

  addAC(wallet: Wallet): Observable<Wallet> {
    return this.http.put<Wallet>('http://localhost:44333/api/administrator/wallet/' + wallet.id , wallet);
  }

  /*getQuestions(): Observable<PagedResults<Question>> {
    return this.http.get<PagedResults<Question>>('http://localhost:44333/api/question/unanswered');
  }*/

  getQuestions(): Observable<Question[]> {
    return this.http.get<Question[]>(`http://localhost:44333/api/question/unanswered`);
  } 
  
  createAnswer(answer: Answer): Observable<Answer> {
    return this.http.post<Answer>('http://localhost:44333/api/answer/createAnswer', answer);
  ...
  getUserById(id: number): Observable<User> {
    return this.http.get<User>('http://localhost:44333/api/users/whole/' + id);
  }

  updateUser(user: User): Observable<User> {
    console.log("dakle posle ovog: ", user);
    return this.http.put<User>('http://localhost:44333/api/users/updateUser/' + user.id + "/" + user.role, user);
  }
}
